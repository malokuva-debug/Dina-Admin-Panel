 ...
 */
export declare const webPushTokenKeys: z.ZodLazy<z.ZodObject<{
    auth: z.ZodString;
    p256dh: z.ZodString;
}, "strip", z.ZodTypeAny, {
    auth: string;
 ...
 */
export declare const webPushTokenKeysResponse: z.ZodLazy<z.ZodEffects<z.ZodObject<{
    auth: z.ZodString;
    p256dh: z.ZodString;
}, "strip", z.ZodTypeAny, {
    auth: string;
 ...
 * Is equal to application shape if all property names match the api schema
 */
export declare const webPushTokenKeysRequest: z.ZodLazy<z.ZodEffects<z.ZodObject<{
    auth: z.ZodString;
    p256dh: z.ZodString;
}, "strip", z.ZodTypeAny, {
    auth: string;
...
//# sourceMappingURL=web-push-token-keys.d.ts.map