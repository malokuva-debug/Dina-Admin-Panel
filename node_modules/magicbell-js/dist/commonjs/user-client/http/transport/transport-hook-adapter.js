    ...
    hookParamsToTransportParams(hookParams, originalTransportParams, encode) {
        ...
        hookParams.forEach((hookParamValue, hookParamKey) => {
            ...
            transportParams.set(hookParamKey, {
                ...
                style: (requestParam === null || requestParam === void 0 ? void 0 : requestParam.style) || base_serializer_js_1.SerializationStyle.NONE,
...
exports.TransportHookAdapter = TransportHookAdapter;
