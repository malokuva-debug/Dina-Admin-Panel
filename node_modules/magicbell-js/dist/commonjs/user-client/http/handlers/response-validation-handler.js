...
exports.ResponseValidationHandler = void 0;
const zod_1 = require("zod");
const types_js_1 = require("../types.js");
const response_matcher_js_1 = require("../utils/response-matcher.js");
class ResponseValidationHandler {
    ...
    decodeBody(request, response) {
        var _a;
        const responseMatcher = new response_matcher_js_1.ResponseMatcher(request.responses);
        ...
        const contentTypeHandlers = {
            [types_js_1.ContentType.Binary]: this.decodeFile,
            [types_js_1.ContentType.Image]: this.decodeFile,
            [types_js_1.ContentType.MultipartFormData]: this.decodeMultipartFormData,
            [types_js_1.ContentType.Text]: this.decodeText,
            [types_js_1.ContentType.Xml]: this.decodeText,
            [types_js_1.ContentType.FormUrlEncoded]: this.decodeFormUrlEncoded,
            [types_js_1.ContentType.EventStream]: this.decodeEventStream,
        };
    ...
    hasContent(responseDefinition, response) {
        return (!!responseDefinition.schema &&
            !(responseDefinition.schema instanceof zod_1.ZodUndefined) &&
...
exports.ResponseValidationHandler = ResponseValidationHandler;
