...
const transport_hook_adapter_js_1 = require("../transport/transport-hook-adapter.js");
const content_type_js_1 = require("../utils/content-type.js");
class HookHandler {
    constructor(hook) {
    ...
    async handle(request) {
        ...
        const hook = new transport_hook_adapter_js_1.TransportHookAdapter();
        ...
        const contentType = (0, content_type_js_1.getContentTypeDefinition)(rawContentType);
        ...
        const decodedBody = new TextDecoder().decode(arrayBuffer);
        throw new error_js_1.HttpError(response.metadata, arrayBuffer, `Unexpected response body for error status.\nStatusCode: ${response.metadata.status}\nBody: ${decodedBody}`);
    }
