...
const base_serializer_js_1 = require("../serialization/base-serializer.js");
const header_serializer_js_1 = require("../serialization/header-serializer.js");
const path_serializer_js_1 = require("../serialization/path-serializer.js");
const query_serializer_js_1 = require("../serialization/query-serializer.js");
...
class Request {
    ...
    addHeaderParam(key, param) {
        ...
        if (param.style === undefined) {
            param.style = base_serializer_js_1.SerializationStyle.SIMPLE;
        }
    ...
    addQueryParam(key, param) {
        ...
        if (param.style === undefined) {
            param.style = base_serializer_js_1.SerializationStyle.FORM;
        }
        if (param.encode === undefined) {
            param.encode = true;
        }
    ...
    constructFullUrl() {
        const queryString = new query_serializer_js_1.QuerySerializer().serialize(this.queryParams);
    ...
    getHeaders() {
        ...
        return new header_serializer_js_1.HeaderSerializer().serialize(this.headers);
    }
    nextPage(cursor) {
        if (!this.pagination) {
            return;
        ...
        if ((0, types_js_1.isRequestCursorPagination)(this.pagination)) {
    ...
    constructPath() {
        return new path_serializer_js_1.PathSerializer().serialize(this.pathPattern, this.pathParams);
    }
    getOffsetParam() {
