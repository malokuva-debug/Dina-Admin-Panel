 ...
 */
export declare const fcmTokenCollection: z.ZodLazy<z.ZodObject<{
 ...
 */
export declare const fcmTokenCollectionResponse: z.ZodLazy<z.ZodEffects<z.ZodObject<{
 ...
 * Is equal to application shape if all property names match the api schema
 */
export declare const fcmTokenCollectionRequest: z.ZodLazy<z.ZodEffects<z.ZodObject<{
    data: z.ZodOptional<z.ZodArray<z.ZodLazy<z.ZodEffects<z.ZodObject<{
        createdAt: z.ZodString;
        deviceToken: z.ZodString;
        discardedAt: z.ZodNullable<z.ZodOptional<z.ZodString>>;
...
//# sourceMappingURL=fcm-token-collection.d.ts.map