import { z } from 'zod';
import { smtpConfigFrom, smtpConfigFromRequest, smtpConfigFromResponse } from './smtp-config-from.js';
import { smtpConfigReplyTo, smtpConfigReplyToRequest, smtpConfigReplyToResponse, } from './smtp-config-reply-to.js';
/**
