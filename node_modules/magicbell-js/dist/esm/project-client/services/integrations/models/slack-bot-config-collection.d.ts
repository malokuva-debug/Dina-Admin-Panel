 ...
 */
export declare const slackBotConfigCollection: z.ZodLazy<z.ZodObject<{
 ...
 */
export declare const slackBotConfigCollectionResponse: z.ZodLazy<z.ZodEffects<z.ZodObject<{
 ...
 * Is equal to application shape if all property names match the api schema
 */
export declare const slackBotConfigCollectionRequest: z.ZodLazy<z.ZodEffects<z.ZodObject<{
    data: z.ZodOptional<z.ZodArray<z.ZodLazy<z.ZodEffects<z.ZodObject<{
        config: z.ZodLazy<z.ZodEffects<z.ZodObject<{
            enabled: z.ZodBoolean;
        }, "strip", z.ZodTypeAny, {
...
//# sourceMappingURL=slack-bot-config-collection.d.ts.map